...
class MonoCorpus(Dataset):
    """
    Class to load bags-of-words and contextualized embeddings for
    monolingual sentence corpora. Used for zero-shot transfer of the
    ContrastZSTM.
    """
    ...
    def __getitem__(self, i):
        ...
        return {"bow": bow, "embedding": embedding}
